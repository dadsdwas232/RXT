...
-- تم تعديل هذا الجزء ليكون آمن تماماً ولا يسبب موت الشخصية
task.spawn(function()
    while task.wait(0.05) do -- سرعة آمنة ومستقرة
            ...
            for _, v in pairs(workspace:GetDescendants()) do
                if v:IsA("TouchTransmitter") then
                    ...
                    if p and (p.Name:lower():find("radioactive") or p.Name:lower():find("coin")) then
                        -- التجميع بدون لمس فيزيائي (Ghost Interest)
...
print("👑 RXT MASTER V10 LOADED - SAFE FARM ACTIVE")
