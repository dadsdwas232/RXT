-- [[ 👑 RXT SERVER - THE ULTIMATE MASTER V4 ]] --
-- Fixed: ON/OFF Indicators | Radioactive Farm | Underground | Full UI
...
if CoreGui:FindFirstChild("RXT_Master_V4") then CoreGui["RXT_Master_V4"]:Destroy() end
local ScreenGui = Instance.new("ScreenGui", CoreGui); ScreenGui.Name = "RXT_Master_V4"
...
CloseBtn.Text = "X"; CloseBtn.BackgroundColor3 = Color3.fromRGB(200, 50, 50); CloseBtn.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", CloseBtn)
...
TabHolder.Size = UDim2.new(1, 0, 0, 45); TabHolder.BackgroundColor3 = Color3.fromRGB(20, 20, 30); Instance.new("UICorner", TabHolder)
...
-- وظيفة إنشاء الأزرار مع تحديث اللون والحالة بوضوح
local function AddToggle(parent, txt, state, cb)
    ...
    local function Update()
        if state then
            b.Text = txt .. " : ON"
            b.BackgroundColor3 = Color3.fromRGB(0, 180, 100) -- أخضر عند التشغيل
        else
            b.Text = txt .. " : OFF"
            b.BackgroundColor3 = Color3.fromRGB(35, 30, 60) -- داكن عند الإيقاف
        end
    end
...
local SpdInput = Instance.new("TextBox", P1); SpdInput.Size = UDim2.new(1, 0, 0, 35); SpdInput.PlaceholderText = "Speed (Default 50)"; SpdInput.BackgroundColor3 = Color3.fromRGB(20, 20, 30); SpdInput.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", SpdInput)
...
-- WORLD PAGE
local bAFK = Instance.new("TextButton", P3); bAFK.Size = UDim2.new(1, 0, 0, 40); bAFK.Text = "💤 Anti-AFK: ALWAYS ON"; bAFK.BackgroundColor3 = Color3.fromRGB(0, 100, 150); bAFK.TextColor3 = Color3.new(1,1,1); bAFK.Font = Enum.Font.GothamBold; Instance.new("UICorner", bAFK)
...
local Footer = Instance.new("TextLabel", Main); Footer.Size = UDim2.new(1, 0, 0, 30); Footer.Position = UDim2.new(0, 0, 1, -30); Footer.Text = "RXT SERVER | OFFICIAL MASTER V4"; Footer.TextColor3 = Color3.fromRGB(150, 100, 255); Footer.BackgroundTransparency = 1; Footer.Font = Enum.Font.GothamBold

print("👑 RXT MASTER V4 LOADED - STATUS INDICATORS FIXED")
